    ...
    <section className="py-20 bg-white border-y-4 border-text relative">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16 ">
          <motion.h2 initial={{scale:0, y:100}} whileInView={{scale:1, y:0}} className="text-4xl md:text-5xl font-black uppercase mb-4 bg-white inline-block px-4 border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
            Built for Retention
          </motion.h2>
        </div>
