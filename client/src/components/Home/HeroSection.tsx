  ...
  return (
    <section className="relative pt-20 pb-32 overflow-hidden flex flex-col items-center justify-center text-center px-4">
      <div className="absolute top-20 left-10 hidden lg:block transform -rotate-12">
        <div className="w-32 h-32 bg-teal-500 border-4 border-black rounded-full flex items-center justify-center">
          <span className="text-white">
            <GraduationCap size={60} />
          </span>
        </div>
      </div>
      <div className="absolute bottom-20 right-10 hidden lg:block transform rotate-12">
        <div className="w-24 h-24 bg-secondary border-4 border-black flex items-center justify-center">
          <span className="">
            <Sparkle size={60} />
          </span>
        </div>
