...
function ResultNotFound() {
  ...
  return (
    <div className="w-full h-screen flex justify-center items-center">
      <div className="box box-shadow w-fit flex justify-center items-center flex-col p-6">
        <div className="w-40">
          <svg
          ...
          >
            ...
            <path
              ...
              fill="#2f2e41"
            />
            <circle cx="559" cy="744.5" r="43" fill="#facc15" />
            <circle cx="54" cy="729.5" r="43" fill="#facc15" />
            <circle cx="54" cy="672.5" r="31" fill="#facc15" />
            <circle cx="54" cy="624.5" r="22" fill="#facc15" />
          </svg>
        </div>
        <div>
          <p className="text-center font-semibold font-sans text-xl max-w-xs">
            Sorry! It seems something has broken we did not get your test. 
          </p>
          <button
            onClick={() => navigate("/generator")}
            className="mt-4 box box-shadow bg-primary text-text w-full p-2 font-bold font-sans select-none cursor-pointer capitalize"
          >
            Generate a new test.
          </button>
        </div>
