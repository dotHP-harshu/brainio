...
function ProfilePage() {
  ...
  return (
    <>
      <HelmetSeo
        title={`${user.userName}'s Profile - Brainio`}
        description={`${user.userName}'s profile on Brainio. View your test history, progress, and more.`}
        keywords="user profile, test history, test progress, Brainio profile, personalized learning"
      />
      <Header />
      <main>
        {editPhoto && (
        ...
        <div className="w-full max-w-3xl mx-auto p-4">
          ...
          <div className="mt-10 border-2 border-error p-4 shadow-[5px_5px_0px_var(--color-error)] space-y-6">
            ...
            <p className="text-base text-error">
              Deleting your account is permanent. This will erase all your
              brainio account details and tests history across all devices.
            </p>
            <button
